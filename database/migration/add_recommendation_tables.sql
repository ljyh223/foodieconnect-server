...
CREATE TABLE `user_restaurant_visits` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_user_restaurant_date` (`user_id`, `restaurant_id`, `visit_date`),
...
-- 4. 添加一些示例数据用于测试
-- 用户餐厅访问历史示例数据
INSERT INTO `user_restaurant_visits` (`user_id`, `restaurant_id`, `visit_date`, `visit_count`, `rating`) VALUES
(1, 1, '2025-11-15', 3, 4.5),
(1, 2, '2025-11-10', 1, 4.0),
(2, 1, '2025-11-12', 2, 4.2),
(2, 3, '2025-11-08', 1, 3.8),
(3, 2, '2025-11-14', 2, 4.6),
(3, 3, '2025-11-11', 1, 4.1),
(4, 1, '2025-11-13', 1, 3.9),
(5, 2, '2025-11-16', 1, 4.3);
...
-- 用户推荐结果示例数据
INSERT INTO `user_recommendations` (`user_id`, `recommended_user_id`, `algorithm_type`, `recommendation_score`, `reason`) VALUES
