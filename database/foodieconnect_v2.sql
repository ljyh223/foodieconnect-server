...
-- ----------------------------
BEGIN;
INSERT INTO `chat_rooms` (`id`, `restaurant_id`, `name`, `verification_code`, `status`, `last_message`, `last_message_time`, `online_user_count`, `verification_code_generated_at`, `created_at`, `updated_at`) VALUES (1, 1, 'Chuanwei Xuan Chat Room', '290777', 'ACTIVE', '测试完成，这是最后一条消息', '2025-12-28 20:04:44', 0, '2026-02-10 14:00:00', '2025-11-01 11:01:55', '2025-12-28 20:04:44');
INSERT INTO `chat_rooms` (`id`, `restaurant_id`, `name`, `verification_code`, `status`, `last_message`, `last_message_time`, `online_user_count`, `verification_code_generated_at`, `created_at`, `updated_at`) VALUES (2, 2, 'Yuexiang Lou Chat Room', '778736', 'ACTIVE', NULL, '2025-11-01 11:01:55', 0, '2026-02-10 14:00:00', '2025-11-01 11:01:55', '2025-11-01 11:01:55');
INSERT INTO `chat_rooms` (`id`, `restaurant_id`, `name`, `verification_code`, `status`, `last_message`, `last_message_time`, `online_user_count`, `verification_code_generated_at`, `created_at`, `updated_at`) VALUES (3, 3, 'Xiangwei Guan Chat Room', '894990', 'ACTIVE', NULL, '2025-11-01 11:01:55', 0, '2026-02-10 14:00:00', '2025-11-01 11:01:55', '2025-11-01 11:01:55');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='User Follow Relationships Table';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='User Recommended Restaurants Table';
...
INSERT INTO `user_restaurant_recommendations` (`id`, `user_id`, `restaurant_id`, `reason`, `rating`, `created_at`, `updated_at`) VALUES (4, 3, 2, NULL, NULL, '2026-02-09 20:00:01', '2026-02-09 20:00:01');
COMMIT;
