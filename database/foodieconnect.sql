...
-- ----------------------------
BEGIN;
INSERT INTO `chat_rooms` (`id`, `restaurant_id`, `name`, `verification_code`, `status`, `last_message`, `last_message_time`, `online_user_count`, `verification_code_generated_at`, `created_at`, `updated_at`) VALUES (1, 1, 'Chuanwei Xuan Chat Room', '767977', 'ACTIVE', '测试完成，这是最后一条消息', '2025-12-28 20:04:44', 0, '2026-02-09 19:30:00', '2025-11-01 11:01:55', '2025-12-28 20:04:44');
INSERT INTO `chat_rooms` (`id`, `restaurant_id`, `name`, `verification_code`, `status`, `last_message`, `last_message_time`, `online_user_count`, `verification_code_generated_at`, `created_at`, `updated_at`) VALUES (2, 2, 'Yuexiang Lou Chat Room', '279842', 'ACTIVE', NULL, '2025-11-01 11:01:55', 0, '2026-02-09 19:30:00', '2025-11-01 11:01:55', '2025-11-01 11:01:55');
INSERT INTO `chat_rooms` (`id`, `restaurant_id`, `name`, `verification_code`, `status`, `last_message`, `last_message_time`, `online_user_count`, `verification_code_generated_at`, `created_at`, `updated_at`) VALUES (3, 3, 'Xiangwei Guan Chat Room', '115673', 'ACTIVE', NULL, '2025-11-01 11:01:55', 0, '2026-02-09 19:30:00', '2025-11-01 11:01:55', '2025-11-01 11:01:55');
COMMIT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜品评价图片表';
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Menu Dish Table';
...
INSERT INTO `reviews` (`id`, `restaurant_id`, `user_id`, `rating`, `comment`, `created_at`, `updated_at`) VALUES (4, 1, 3, 4, 'hello flutter', '2025-10-31 21:42:16', '2025-10-31 21:42:16');
INSERT INTO `reviews` (`id`, `restaurant_id`, `user_id`, `rating`, `comment`, `created_at`, `updated_at`) VALUES (7, 2, 3, 4, 'hello flutter', '2025-10-31 21:46:17', '2025-10-31 21:46:17');
INSERT INTO `reviews` (`id`, `restaurant_id`, `user_id`, `rating`, `comment`, `created_at`, `updated_at`) VALUES (12, 3, 3, 5, '123', '2025-11-01 09:55:26', '2025-11-01 09:55:26');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `staff` (`id`, `restaurant_id`, `name`, `position`, `status`, `experience`, `rating`, `avatar_url`, `created_at`, `updated_at`) VALUES (1, 1, 'Xiao Zhang', 'Waiter', 'ONLINE', '3 years', 4.95, '/uploads/orangestar.png', '2025-10-05 14:54:32', '2026-02-09 19:53:00');
INSERT INTO `staff` (`id`, `restaurant_id`, `name`, `position`, `status`, `experience`, `rating`, `avatar_url`, `created_at`, `updated_at`) VALUES (2, 1, 'Xiao Li', 'Team Leader', 'ONLINE', '5 years', 4.90, '/uploads/ee.png', '2025-10-05 14:54:32', '2026-02-09 19:53:30');
INSERT INTO `staff` (`id`, `restaurant_id`, `name`, `position`, `status`, `experience`, `rating`, `avatar_url`, `created_at`, `updated_at`) VALUES (3, 2, 'Xiao Wang', 'Waiter', 'ONLINE', '2 years', 4.70, '/uploads/109951166145983724.webp', '2025-10-05 14:54:32', '2026-02-09 19:54:05');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `staff_reviews` (`id`, `staff_id`, `user_id`, `rating`, `content`, `created_at`) VALUES (1, 1, 1, 5.00, 'Excellent service attitude, very professional dish recommendations', '2025-10-05 14:54:32');
INSERT INTO `staff_reviews` (`id`, `staff_id`, `user_id`, `rating`, `content`, `created_at`) VALUES (2, 1, 2, 4.50, 'Attentive service and patient in answering questions', '2025-10-05 14:54:32');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='User Follow Relationships Table';
...
INSERT INTO `user_follows` (`id`, `follower_id`, `following_id`, `created_at`) VALUES (4, 3, 1, '2025-11-03 21:29:50');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='User Recommendation Results Table';
...
INSERT INTO `user_recommendations` (`id`, `user_id`, `recommended_user_id`, `algorithm_type`, `recommendation_score`, `recommendation_reason`, `is_viewed`, `is_interested`, `feedback`, `created_at`, `updated_at`) VALUES (6, 3, 2, 'WEIGHTED', 0.4757, '您和Li Si都喜欢Hunan Cuisine，如Xiangwei Guan，可能有相似的口味偏好', 0, NULL, NULL, '2025-11-19 10:57:54', '2026-02-09 19:54:56');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='User Recommended Restaurants Table';
